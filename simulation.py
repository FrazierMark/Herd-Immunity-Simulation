...
class Simulation(object):
    ...
    # TODO: Loop over your population
        ...
        for person in self.population:
            if person.infection is not None:
                for i in range(100):
                    random_person = random.choice(population_copy)
                    if random_person.isAlive:
    ...
    def interaction(self, infected_person, random_person):
        ...
        # nothing happens to random person.
            ...
            print("random person is already infected")
        ...
        elif not random_person.is_vaccinated and not random_person.infection:
...
if __name__ == "__main__":
    ...
    new_sim = Simulation(virus, pop_size, vacc_percentage, initial_infected)
    print("NEW SIMULATION POPULATION", len(new_sim.population))
